...
/**
 ...
 Modified by Psyukalov;
 
 */

typedef void(^MBAutoGrowingTextViewDidChangeConstraint)(void);

@interface MBAutoGrowingTextView : UITextView

@property (copy, nonatomic) MBAutoGrowingTextViewDidChangeConstraint didChangeConstraint;
